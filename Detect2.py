...
def TwoLineIntersection(o1,  p1,  o2,  p2):
    """
    Function Takes 2Lines A(o1,p1) B(o2,p2)
    Returns True if Intersected and the X,Y Coodrs of the Intersection
    """
    x = o2 - o1
    d1 = p1 - o1
    d2 = p2 - o2
...
# 1/5 of the total Width
    ...
    if flag_V1 == True and flag_V2 == True : 
        ...
        if r_V1[0] >  r_V2[0]:
            ...
            return (frame, (r_V2[0] + Width), math.ceil(abs(r_V2+Vert_Line[1][1])/2))
...
for NIMG in range(x,x+500):
    ...
    frame = cv2.imread("E:/ASMarine_21/robosub_transdec_dataset/Images/"+str(i)+'.jpg' ,-1)
